...
if __name__ == '__main__':
    ...
    print('edges_set', [len(l) for l in edges_set])  # 把大于lim的边的都合并
    ...
    fc_vectors = [x[1] for x in fcfile]  # 2048 weight + 1 bias 
    ...
    v_train, v_val = map(float, args.trainval.split(','))  # train和val的比例
