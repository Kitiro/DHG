...
from models.gcn_dense_aux import GCN_Dense_Aux
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight-file', default='materials/imagenet-multi-weight-graph-pred-visual.mat')
    ...
    aux_data = np.hstack((hops, semantic_dis, visual_dis))

    print('aux_data-[hops, semantic_dis, visual_dis]:', aux_data.shape)
