...
from utils import ensure_path, set_gpu, l2_loss, EarlyStopping
from utils import DataSet_reverse as DataSet

from models.gcn_att_r import GCN_Dense_Aux
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='save/gcn-att-r')
