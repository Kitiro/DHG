...
from models.gcn_hier_aux_edges import GCN_Dense_Aux
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='save/gcn-hier-aux')
    parser.add_argument('--weight-file', default='materials/directed-hierarchy-nell-graph.mat')
